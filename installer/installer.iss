...
[Run]
Filename: "{app}\ImportadorXLS.exe"; Parameters: "install"; StatusMsg: "Instalando serviço..."; Flags: runhidden
Filename: "net"; Parameters: "start ImportadorXLS"; StatusMsg: "Iniciando serviço..."; Flags: runhidden
...
begin
  ConfigPath := 'C:\Viasoft\Client\PlugIns\pluggy_config.json';
  if not FileExists(ConfigPath) then
  begin
    ConfigContent := '{"oracle":{"modo_conexao":"DIRETO","usuario":"VIASOFT","senha":"",' +
                     '"direto":{"host":"","porta":1521,"sid":"ORCL","service_name":""},' +
